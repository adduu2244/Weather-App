'http://api.weatherapi.com/v1/current.json?key=9eddfccb080a477c93755959260204&q=mumbai&aqi=no'
...
const fetchResults = async (targetLocation) =>{
    ...
    let url = `http://api.weatherapi.com/v1/current.json?key=9eddfccb080a477c93755959260204&q=${targetLocation}&aqi=no`;
